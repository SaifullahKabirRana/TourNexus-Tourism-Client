...
const Achievements = () => {
	...
	<div className="container grid grid-cols-2 gap-3 md:gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
		<div className="flex p-4 space-x-3 rounded-lg md:space-x-6 dark:bg-gray-50 dark:text-gray-800">
			<div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-[#6dee61] hover:bg-[#56b63e] w-[80px] md:w-[80px] md:h-[80px] h-[70px] mt-1 md:mt-0">
				<img className='w-[40px] md:w-[50px]' src={logo1} alt="" />
			</div>
		...
		<div className="flex p-4 space-x-3 rounded-lg md:space-x-6 dark:bg-gray-50 dark:text-gray-800">
			<div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-[#6dee61] hover:bg-[#56b63e]  w-[80px] md:w-[80px] md:h-[80px] h-[70px] mt-1 md:mt-0">
            <img className='w-[30px] md:w-[50px]' src={logo2} alt="" />
			</div>
			<div className="flex flex-col justify-center align-middle font-openSans">
		...
		<div className="flex p-4 space-x-3 rounded-lg md:space-x-6 dark:bg-gray-50 dark:text-gray-800">
			<div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-[#6dee61] hover:bg-[#56b63e]  w-[80px] md:w-[80px] md:h-[80px] h-[70px] mt-1 md:mt-0">
            <img className='w-[30px] md:w-[50px]' src={logo3} alt="" />
			</div>
			<div className="flex flex-col justify-center align-middle font-openSans">
		...
		<div className="flex p-4 space-x-3 rounded-lg md:space-x-6 dark:bg-gray-50 dark:text-gray-800">
			<div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-[#6dee61] hover:bg-[#56b63e]  w-[80px] md:w-[80px] md:h-[80px] h-[70px] mt-1 md:mt-0">
            <img className='w-[30px] md:w-[50px]' src={logo4} alt="" />
			</div>
