            ...
            <div className='bg-[#12132D0D] mt-12 md:mt-16 lg:mt-24 '>
                <div className='md:flex container mx-auto'>
                    <div className='mx-7 md:mx-10 pt-[35px] md:pt-[60px] lg:pt-[100px]'>
                        ...
                        <div className='mt-3 md:mt-5 lg:mt-7 flex gap-2 md:gap-3 lg:gap-4 text-[20px] md:text-[30px] lg::text-[40px] text-black'>
                            <a href="#"><FaFacebook /></a>
                            <a href="#"><BsTwitterX /></a>
                        ...
                        <div className='flex flex-row items-center gap-2 md:gap-4 text-base md:text-[20px] mt-3 md:mt-5 lg:mt-7'>
                            ...
                            <p className='text-black font-openSans text-[15px] md:text-[20px]'>+88 01533 333 333</p>
                        </div>
                        <div className='flex flex-row items-center gap-2 md:gap-4 text-base md:text-[20px] mt-1 md:mt-2 lg:mt-3 '>
                            ...
                            <p className='text-black font-openSans text-[15px] md:text-[20px]'>info@gmail.com</p>
                        </div>
                        <div className='flex flex-row items-center gap-2 md:gap-4 text-base md:text-[20px] mt-1 md:mt-2 lg:mt-3'>
                            <IoLocationSharp className='text-[#63AB45] text-[18px] md:text-[22px]' />
                            <p className='text-black font-openSans text-[15px] md:text-[20px]'>72, Wall street, King Road, Dhaka</p>
                        </div>
                        ...
                        <section className="">
                            <form noValidate="" className="space-y-2 md:space-y-4 lg:space-y-6  ">
                                ...
                                <div>
                                    ...
                                    <input type="text" placeholder="Name" className="input h-[35px] md:h-[40px] lg:h-[50px] w-[250px] md:w-[280px] lg:w-[450px] text-[13px] md:text-[15px]" />
                                </div>
                                <div>
                                    <input type="email" placeholder="Email" className="input h-[35px] md:h-[40px] lg:h-[50px] w-[250px] md:w-[280px] lg:w-[450px] text-[13px] md:text-[15px]" />
                                </div>
                                <div>
                                    <textarea
                                        placeholder="Message"
                                        className="textarea textarea-lg focus:border-none  text-[13px] md:text-[15px] w-[250px] md:w-[280px] lg:w-[450px]"></textarea>
                                </div>
                                <div>
                                    <button className='text-black btn rounded-full btn-outline border-2 border-black hover:bg-transparent hover:text-[#63AB45] hover:border-[#63AB45] font-quicksand text-[18px] md:text-[21px] lg:text-[24px] btn-sm md:btn-md'>Send Message</button>
                                </div>
                            </form>
                        </section>
                    </div>
